...
def register_types(module):
    ...
    module.add_enum('DropReason', ['DUPLICATED', 'SUPPRESSED', 'NO_FACES', 'NON_DUPLICATED', 'AFTER_SATISFIED', 'UNSOLICITED', 'PIT_LIMIT'], outer_class=root_module['ns3::Ccnx'])
...
def register_Ns3CcnxContentStore_methods(root_module, cls):
    ...
    ## ccnx-content-store.h (module 'ndnSIM'): bool ns3::CcnxContentStore::Add(ns3::Ptr<ns3::CcnxContentObjectHeader> header, ns3::Ptr<const ns3::Packet> packet) [member function]
    cls.add_method('Add', 
                   'bool', 
...
def register_Ns3CcnxContentStoreEntry_methods(root_module, cls):
    ...
    ## ccnx-content-store.h (module 'ndnSIM'): ns3::CcnxContentStoreEntry::CcnxContentStoreEntry(ns3::Ptr<ns3::CcnxContentObjectHeader> header, ns3::Ptr<const ns3::Packet> packet) [constructor]
    ...
    cls.add_method('GetFullyFormedCcnxPacket', 
                   ...
                   [], 
                   is_const=True)
    ## ccnx-content-store.h (module 'ndnSIM'): ns3::Ptr<const ns3::CcnxContentObjectHeader> ns3::CcnxContentStoreEntry::GetHeader() const [member function]
