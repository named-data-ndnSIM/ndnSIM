...
def register_types(module):
    ...
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): ns3::CcnxNameComponentsTag [class]
    module.add_class('CcnxNameComponentsTag', parent=root_module['ns3::Tag'])
...
def register_methods(root_module):
    ...
    register_Ns3CcnxNameComponentsTag_methods(root_module, root_module['ns3::CcnxNameComponentsTag'])
...
def register_Ns3CcnxContentObjectHeader_methods(root_module, cls):
    ...
    cls.add_method('GetInstanceTypeId', 
                   ...
                   [], 
                   is_const=True, is_virtual=True)
    ## ccnx-content-object-header.h (module 'NDNabstraction'): ns3::Ptr<ns3::CcnxNameComponents const> ns3::CcnxContentObjectHeader::GetName() const [member function]
    cls.add_method('GetName', 
                   'ns3::Ptr< ns3::CcnxNameComponents const >', 
                   [], 
                   is_const=True)
    ## ccnx-content-object-header.h (module 'NDNabstraction'): ns3::Vector const & ns3::CcnxContentObjectHeader::GetPosition() const [member function]
    ...
    ## ccnx-content-object-header.h (module 'NDNabstraction'): void ns3::CcnxContentObjectHeader::SetPosition(ns3::Vector const & position) [member function]
...
def register_Ns3CcnxFace_methods(root_module, cls):
    ...
    cls.add_method('Send', 
                   ...
                   [param('ns3::Ptr< ns3::Packet >', 'p')], 
                   is_virtual=True)
    ## ccnx-face.h (module 'NDNabstraction'): void ns3::CcnxFace::SendLowPriority(ns3::Ptr<ns3::Packet> p) [member function]
    cls.add_method('SendLowPriority', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'p')], 
                   is_virtual=True)
...
def register_Ns3CcnxInterestHeader_methods(root_module, cls):
    ...
    cls.add_method('GetNack', 
                   ...
                   [], 
                   is_const=True)
    ## ccnx-interest-header.h (module 'NDNabstraction'): ns3::Ptr<ns3::CcnxNameComponents const> ns3::CcnxInterestHeader::GetName() const [member function]
    cls.add_method('GetName', 
                   'ns3::Ptr< ns3::CcnxNameComponents const >', 
                   [], 
                   is_const=True)
    ...
    cls.add_method('GetNonce', 
                   ...
                   [], 
                   is_const=True)
    ## ccnx-interest-header.h (module 'NDNabstraction'): ns3::Vector const & ns3::CcnxInterestHeader::GetPosition() const [member function]
    cls.add_method('GetPosition', 
                   'ns3::Vector const &', 
                   [], 
                   is_const=True)
    ...
    ## ccnx-interest-header.h (module 'NDNabstraction'): void ns3::CcnxInterestHeader::SetPosition(ns3::Vector const & position) [member function]
    cls.add_method('SetPosition', 
                   'void', 
                   [param('ns3::Vector const &', 'position')])
...
def register_Ns3CcnxNameComponentsTag_methods(root_module, cls):
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): ns3::CcnxNameComponentsTag::CcnxNameComponentsTag(ns3::CcnxNameComponentsTag const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::CcnxNameComponentsTag const &', 'arg0')])
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): ns3::CcnxNameComponentsTag::CcnxNameComponentsTag(ns3::Ptr<ns3::CcnxNameComponents const> const & name) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::CcnxNameComponents const > const &', 'name')])
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): void ns3::CcnxNameComponentsTag::Deserialize(ns3::TagBuffer arg0) [member function]
    cls.add_method('Deserialize', 
                   'void', 
                   [param('ns3::TagBuffer', 'arg0')], 
                   is_virtual=True)
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): ns3::Ptr<ns3::CcnxNameComponents const> const & ns3::CcnxNameComponentsTag::GetName() const [member function]
    cls.add_method('GetName', 
                   'ns3::Ptr< ns3::CcnxNameComponents const > const &', 
                   [], 
                   is_const=True)
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): uint32_t ns3::CcnxNameComponentsTag::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): static ns3::TypeId ns3::CcnxNameComponentsTag::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): void ns3::CcnxNameComponentsTag::Print(std::ostream & arg0) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'arg0')], 
                   is_const=True, is_virtual=True)
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): void ns3::CcnxNameComponentsTag::Serialize(ns3::TagBuffer arg0) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::TagBuffer', 'arg0')], 
                   is_const=True, is_virtual=True)
    ## ccnx-name-components-tag.h (module 'NDNabstraction'): void ns3::CcnxNameComponentsTag::SetName(ns3::Ptr<ns3::CcnxNameComponents const> const & name) [member function]
    cls.add_method('SetName', 
                   'void', 
                   [param('ns3::Ptr< ns3::CcnxNameComponents const > const &', 'name')])
    return
