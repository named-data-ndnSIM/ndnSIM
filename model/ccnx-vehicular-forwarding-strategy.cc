...
#include "ccnx-vehicular-forwarding-strategy.h"
...
NS_LOG_COMPONENT_DEFINE ("CcnxVehicularForwardingStrategy");
...
NS_OBJECT_ENSURE_REGISTERED (CcnxVehicularForwardingStrategy);
    
TypeId
CcnxVehicularForwardingStrategy::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::CcnxVehicularForwardingStrategy")
    .SetGroupName ("Ccnx")
    .SetParent <CcnxForwardingStrategy> ()
    .AddConstructor <CcnxVehicularForwardingStrategy> ()
    ;
  return tid;
}
    
CcnxVehicularForwardingStrategy::CcnxVehicularForwardingStrategy ()
{
}

bool
CcnxVehicularForwardingStrategy::PropagateInterest (const CcnxPitEntry  &pitEntry, 
